...
@section('content')
    ...
    <div class="container mt-5 py-3">
        ...
        <div class="col-12 col-lg-10 mx-auto bg-white shadow py-2 px-5 rounded">
            ...
            <h2 class="text-center mt-3">Crear nuevo servicio</h2>

            <form method="POST" action="{{route ('administracion.servicios.store')}}" enctype="multipart/form-data" novalidate>
                @csrf
