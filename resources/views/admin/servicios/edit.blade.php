...
@section('content')
    ...
    <div class="container mt-5 py-3">
        ...
        <div class="col-12 col-lg-10 mx-auto bg-white shadow py-2 px-5 rounded">
            ...
            <h2 class="text-center mt-3">Editar terapia</h2>

            <form method="POST" action="{{route ('administracion.servicios.update',$servicio)}}" enctype="multipart/form-data" novalidate>
                @csrf
                @method('put')

                <div class="mt-4">
                    <p>Imagen actual:</p>
                    <img src="/storage/{{$servicio->imagen}}" style="width:300px"alt="">
                </div>
                ...
                <div class="form-group my-5 mx-2">
                    <label for="precioPeso">Precio peso </label>
                    <input type="number" 
                    name="precioPeso" 
                    class="form-control @error('precioPeso') is-invalid @enderror" id="precioPeso"
                        value="{{$servicio->precioPeso}}">
                    @error('precioPeso')
                    <span class="invalid-feedback d-block" role="alert">
                        <strong>{{ $message }}</strong>
                    </span>
                ...
                <div class="form-group">
                    ...
                    <select name="estado" id="estado" class="form-control w-25 @error('estado') is-invalid @enderror">
                        ...
                        @if($servicio->estado == 1)
                            <option value="{{$servicio->estado}}">ACTIVO</option>
                            <option value="0">DESACTIVADO</option>
                        @else
                            <option value="{{$servicio->estado}}">DESACTIVADO</option>
                ...
                <div class="form-group">
                    <input type="submit" class="btn btn-success shadow rounded" value="Actualizar terapia">
                </div>
