...
@section('content')
    ...
    <div class="container mt-5 py-3">
        ...
        <div class="col-12 col-lg-10 mx-auto bg-white shadow py-2 px-5 rounded">
            ...
            <h2 class="text-center mt-3">Editando terapia EU</h2>

            <form method="POST" action="{{route ('administracion.servicios-ingles.update',$ingle)}}" enctype="multipart/form-data" novalidate>
                @csrf
                @method('put')

                <div class="mt-4">
                    <p>Imagen actual:</p>
                    <img src="/storage/{{$ingle->imagen}}" style="width:300px"alt="">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="estado" id="estado" class="form-control w-25 @error('estado') is-invalid @enderror">
                        ...
                        @if($ingle->estado == 1)
                                <option value="{{$ingle->estado}}">ACTIVO</option>
                                <option value="0">DESACTIVADO</option>
                            @else
                                <option value="{{$ingle->estado}}">DESACTIVADO</option>
                ...
                <div class="form-group">
                    <input type="submit" class="btn btn-success shadow rounded" value="Editar terapia EU">
                </div>
