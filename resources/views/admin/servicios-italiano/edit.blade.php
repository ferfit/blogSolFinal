...
@section('content')
    ...
    <div class="container mt-5 py-3">
        ...
        <div class="col-12 col-lg-10 mx-auto bg-white shadow py-2 px-5 rounded">
            ...
            <h2 class="text-center mt-3">Editando terapia IT</h2>

            <form method="POST" action="{{route ('administracion.servicios-italiano.update',$italiano)}}" enctype="multipart/form-data" novalidate>
                @csrf
                @method('put')

                <div class="mt-4">
                    <p>Imagen actual:</p>
                    <img src="/storage/{{$italiano->imagen}}" style="width:300px"alt="">
                </div>
                ...
                <div class="form-group">
                    ...
                    <select name="estado" id="estado" class="form-control w-25 @error('estado') is-invalid @enderror">
                        ...
                        @if($italiano->estado == 1)
                                <option value="{{$italiano->estado}}">ACTIVO</option>
                                <option value="0">DESACTIVADO</option>
                            @else
                                <option value="{{$italiano->estado}}">DESACTIVADO</option>
                ...
                <div class="form-group">
                    <input type="submit" class="btn btn-success shadow rounded" value="Editar terapia IT">
                </div>
