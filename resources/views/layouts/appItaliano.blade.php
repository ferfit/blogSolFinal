...
<head>
    ...
    <title>Terapista olistica Solange Margot</title>
    <meta name="description" content="Accompagnamento personalizzato, con varie terapie, per il benessere del corpo, della mente e dell'energia.">
    <meta name="keywords" content="terapia, energia, bioneuroemotion, guarigione, costellazioni, tethahealing, registri akashici, reiki">
...
<body>
    <div id="app">
    @include('includes.headerItaliano')
